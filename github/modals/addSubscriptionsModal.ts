...
export async function AddSubscriptionModal({ modify, read, persistence, http, slashcommandcontext, uikitcontext }: { modify: IModify, read: IRead, persistence: IPersistence, http: IHttp ,slashcommandcontext?: SlashCommandContext, uikitcontext?: UIKitInteractionContext }): Promise<IUIKitModalViewParam> {
    ...
    if (user?.id) {
        ...
        block.addInputBlock({
            ...
            label: { text: ModalsEnum.REPO_NAME_LABEL, type: TextObjectType.PLAINTEXT },
            element: block.newPlainTextInputElement({
                actionId: ModalsEnum.REPO_NAME_INPUT_ACTION,
                placeholder :  { text: ModalsEnum.REPO_NAME_PLACEHOLDER, type: TextObjectType.PLAINTEXT },
            })
        });
        ...
        block.addInputBlock({
            label: { text:ModalsEnum.ADD_SUBSCRIPTION_EVENT_LABEL, type: TextObjectType.PLAINTEXT }, 
