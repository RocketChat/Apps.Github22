...
export async function MainModal({
	...
	block.addSectionBlock({
		...
		text: block.newMarkdownTextObject(
			ModalsEnum.MAIN_MODAL_GITHUB_SEARCH_LABLE,
		),
	...
	block.addContextBlock({
		...
		elements: [
			block.newMarkdownTextObject(
				ModalsEnum.MAIN_MODAL_GITHUB_SEARCH_DESCRIPTION,
			),
		],
	});
	...
	block.addSectionBlock({
		blockId: ModalsEnum.MAIN_MODAL_VIEW,
		text: block.newMarkdownTextObject(
			ModalsEnum.MAIN_MODAL_NEW_ISSUE_LABLE,
		),
		accessory: block.newButtonElement({
			text: {
				type: TextObjectType.PLAINTEXT,
	...
	block.addContextBlock({
		...
		elements: [
			block.newMarkdownTextObject(
				ModalsEnum.MAIN_MODAL_NEW_ISSUE_DESCRIPTION,
			),
		],
	});
	...
	block.addSectionBlock({
		blockId: ModalsEnum.MAIN_MODAL_VIEW,
		text: block.newMarkdownTextObject(
			ModalsEnum.MAIN_MODAL_REPOSITORY_SUBSCRIPTIONS_LABLE,
		),
		accessory: block.newButtonElement({
			text: {
				type: TextObjectType.PLAINTEXT,
	...
	block.addContextBlock({
		...
		elements: [
			block.newMarkdownTextObject(
				ModalsEnum.MAIN_MODAL_REPOSITORY_SUBSCRIPTIONS_DESCRIPTION,
			),
		],
	});
	...
	block.addSectionBlock({
		blockId: ModalsEnum.MAIN_MODAL_VIEW,
		text: block.newMarkdownTextObject(
			ModalsEnum.MAIN_MODAL_ASSIGN_ISSUES_LABLE,
		),
		accessory: block.newButtonElement({
			text: {
				type: TextObjectType.PLAINTEXT,
	...
	block.addContextBlock({
		...
		elements: [
			block.newMarkdownTextObject(
				ModalsEnum.MAIN_MODAL_ASSIGN_ISSUES_DESCRIPTION,
			),
		],
	});
